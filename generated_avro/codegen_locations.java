...
//
// Debug information:
// Generated date: Fri Apr 10 15:35:13 MSK 2026
...
public class codegen_locations extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    setters.put("id", new FieldSetterCommand() {
      ...
      public void setField(Object value) {
        codegen_locations.this.id = (Long)value;
      }
    });
    setters.put("location_key", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_locations.this.location_key = (String)value;
      }
    });
    setters.put("start_lat", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_locations.this.start_lat = (Double)value;
      }
    });
    setters.put("start_lng", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_locations.this.start_lng = (Double)value;
      }
    });
    setters.put("end_lat", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_locations.this.end_lat = (Double)value;
      }
    });
    setters.put("end_lng", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_locations.this.end_lng = (Double)value;
      }
    });
    setters.put("street", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_locations.this.street = (String)value;
      }
    });
    setters.put("city", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_locations.this.city = (String)value;
      }
    });
    setters.put("county", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_locations.this.county = (String)value;
      }
    });
    setters.put("state", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_locations.this.state = (String)value;
      }
    });
    setters.put("zipcode", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_locations.this.zipcode = (String)value;
      }
    });
    setters.put("country", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_locations.this.country = (String)value;
      }
    });
    setters.put("timezone", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_locations.this.timezone = (String)value;
      }
    });
  }
  public codegen_locations() {
    init0();
  }
  private Long id;
  public Long get_id() {
  ...
  public codegen_locations with_id(Long id) {
    this.id = id;
    return this;
  }
  ...
  public codegen_locations with_location_key(String location_key) {
    this.location_key = location_key;
    return this;
  }
  ...
  public codegen_locations with_start_lat(Double start_lat) {
    this.start_lat = start_lat;
    return this;
  }
  ...
  public codegen_locations with_start_lng(Double start_lng) {
    this.start_lng = start_lng;
    return this;
  }
  ...
  public codegen_locations with_end_lat(Double end_lat) {
    this.end_lat = end_lat;
    return this;
  }
  ...
  public codegen_locations with_end_lng(Double end_lng) {
    this.end_lng = end_lng;
    return this;
  }
  ...
  public codegen_locations with_street(String street) {
    this.street = street;
    return this;
  }
  private String city;
  ...
  public codegen_locations with_city(String city) {
    this.city = city;
    return this;
  }
  ...
  public codegen_locations with_county(String county) {
    this.county = county;
    return this;
  }
  ...
  public codegen_locations with_state(String state) {
    this.state = state;
    return this;
  }
  ...
  public codegen_locations with_zipcode(String zipcode) {
    this.zipcode = zipcode;
    return this;
  }
  ...
  public codegen_locations with_country(String country) {
    this.country = country;
    return this;
  }
  ...
  public codegen_locations with_timezone(String timezone) {
    this.timezone = timezone;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof codegen_locations)) {
      return false;
    }
    codegen_locations that = (codegen_locations) o;
    boolean equal = true;
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    codegen_locations o = (codegen_locations) super.clone();
    return o;
  }

  public void clone0(codegen_locations o) throws CloneNotSupportedException {
  }
