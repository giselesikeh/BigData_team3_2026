...
//
// Debug information:
// Generated date: Fri Apr 10 16:11:34 MSK 2026
...
public class weather extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    ...
    setters.put("weather_key", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weather.this.weather_key = (String)value;
      }
    });
    ...
    setters.put("temperature_f", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weather.this.temperature_f = (Double)value;
      }
    });
    setters.put("wind_chill_f", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weather.this.wind_chill_f = (Double)value;
      }
    });
    setters.put("humidity_pct", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weather.this.humidity_pct = (Double)value;
      }
    });
    setters.put("pressure_in", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weather.this.pressure_in = (Double)value;
      }
    });
    setters.put("visibility_mi", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weather.this.visibility_mi = (Double)value;
      }
    });
    ...
    setters.put("wind_speed_mph", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weather.this.wind_speed_mph = (Double)value;
      }
    });
    setters.put("precipitation_in", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        weather.this.precipitation_in = (Double)value;
      }
    });
  ...
  public weather with_weather_key(String weather_key) {
    this.weather_key = weather_key;
    return this;
  }
  ...
  public weather with_temperature_f(Double temperature_f) {
    this.temperature_f = temperature_f;
    return this;
  }
  ...
  public weather with_wind_chill_f(Double wind_chill_f) {
    this.wind_chill_f = wind_chill_f;
    return this;
  }
  ...
  public weather with_humidity_pct(Double humidity_pct) {
    this.humidity_pct = humidity_pct;
    return this;
  }
  ...
  public weather with_pressure_in(Double pressure_in) {
    this.pressure_in = pressure_in;
    return this;
  }
  ...
  public weather with_visibility_mi(Double visibility_mi) {
    this.visibility_mi = visibility_mi;
    return this;
  }
  ...
  public weather with_wind_speed_mph(Double wind_speed_mph) {
    this.wind_speed_mph = wind_speed_mph;
    return this;
  }
  ...
  public weather with_precipitation_in(Double precipitation_in) {
    this.precipitation_in = precipitation_in;
    return this;
  }
