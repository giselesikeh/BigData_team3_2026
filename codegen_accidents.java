...
//
// Debug information:
// Generated date: Fri Apr 10 15:34:04 MSK 2026
...
public class codegen_accidents extends SqoopRecord  implements DBWritable, Writable {
  ...
  private void init0() {
    ...
    setters.put("source", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_accidents.this.source = (String)value;
      }
    });
    ...
    setters.put("distance_mi", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_accidents.this.distance_mi = (Double)value;
      }
    });
    setters.put("description", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_accidents.this.description = (String)value;
      }
    });
    setters.put("location_id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_accidents.this.location_id = (Long)value;
      }
    });
    setters.put("weather_id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_accidents.this.weather_id = (Long)value;
      }
    });
    setters.put("twilight_id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_accidents.this.twilight_id = (Integer)value;
      }
    });
    setters.put("road_feat_id", new FieldSetterCommand() {
      @Override
      public void setField(Object value) {
        codegen_accidents.this.road_feat_id = (Integer)value;
      }
    });
  }
  ...
  public codegen_accidents with_source(String source) {
    this.source = source;
    return this;
  }
  ...
  public codegen_accidents with_distance_mi(Double distance_mi) {
    this.distance_mi = distance_mi;
    return this;
  }
  ...
  public codegen_accidents with_description(String description) {
    this.description = description;
    return this;
  }
  ...
  public codegen_accidents with_location_id(Long location_id) {
    this.location_id = location_id;
    return this;
  }
  ...
  public codegen_accidents with_weather_id(Long weather_id) {
    this.weather_id = weather_id;
    return this;
  }
  ...
  public codegen_accidents with_twilight_id(Integer twilight_id) {
    this.twilight_id = twilight_id;
    return this;
  }
  ...
  public codegen_accidents with_road_feat_id(Integer road_feat_id) {
    this.road_feat_id = road_feat_id;
    return this;
  }
